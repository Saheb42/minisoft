<nav id="sidebar" aria-label="Main Navigation">
    ...
    <div class="content-header">
        ...
        <a class="fw-semibold text-dual" href="index.html">
            ...
            <span class="smini-hide fs-5 tracking-wider">Web<span class="fw-normal">UI</span></span>
        </a>
        <!-- END Logo -->
            ...
            <ul class="nav-main">
                ...
                <li class="nav-main-item">
                    ...
                    <ul class="nav-main-submenu">
                        <li class="nav-main-item">
                            <a class="nav-main-link" href="{{ route('admin.service_view') }}">
                ...
                <li class="nav-main-item">
                    ...
                    <ul class="nav-main-submenu">
                        <li class="nav-main-item">
                            <a class="nav-main-link" href="{{ route('admin.staffs_view') }}">
                                <span class="nav-main-link-name">Add Staff</span>
                            </a>
                        </li>
                        <li class="nav-main-item">
                            <a class="nav-main-link" href="#">
                                <span class="nav-main-link-name">View Staff</span>
                            </a>
                        </li>
                    </ul>
                </li>
